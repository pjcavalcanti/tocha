...
for _ in range(5):
    ...
    dec_layer_tocha = TransformerDecoderLayer(
        d_model=d_model,
        nhead=nhead,
        dim_feedforward=dim_feedforward,
        dropout=dropout,
    ...
    dec_tocha = TransformerDecoder(dec_layer_tocha, num_layers=num_layers)
    ...
    print(passbackward_tgt)
    print(passbackward_memory)